...
By framing the comparison explicitly, we aim to provide the field with an empirical benchmark: not a definitive verdict on digital phenotyping, but a systematic reality check against a simple, well-validated baseline that most sensing studies have overlooked. If a five-minute questionnaire consistently matches or exceeds weeks of continuous sensing, this carries important implications for how the digital mental health field allocates resources, designs studies, and evaluates progress.
