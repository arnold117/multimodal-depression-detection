...
Output: results/by_study/s1/tables/mediation_simple.csv
        results/by_study/s1/tables/mediation_parallel.csv
        results/by_study/s1/figures/mediation_forest_plot.png
        results/by_study/s1/figures/mediation_path_diagram.png
"""
