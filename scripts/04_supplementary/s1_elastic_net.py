...
Output: results/by_study/s1/tables/elastic_net_comparison.csv
        results/by_study/s1/tables/elastic_net_coefficients.csv
        results/by_study/s1/figures/elastic_net_model_comparison.png
        results/by_study/s1/figures/elastic_net_coefficients.png
        results/by_study/s1/figures/elastic_net_predicted_vs_actual.png
        results/by_study/s1/figures/elastic_net_feature_importance.png
"""
