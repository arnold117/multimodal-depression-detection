...
Output: results/by_study/s1/tables/plssem_results.csv
        results/by_study/s1/tables/plssem_effects.csv
        results/by_study/s1/figures/plssem_path_diagram.png
        results/by_study/s1/figures/plssem_r_squared.png
"""
