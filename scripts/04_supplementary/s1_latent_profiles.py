...
Output: results/by_study/s1/tables/lpa_fit_indices.csv
        results/by_study/s1/tables/lpa_profiles.csv
        results/by_study/s1/tables/lpa_outcome_comparison.csv
        results/by_study/s1/figures/lpa_bic.png
        results/by_study/s1/figures/lpa_radar.png
        results/by_study/s1/figures/lpa_outcomes.png
"""
