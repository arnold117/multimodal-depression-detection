...
Output: data/processed/nethealth/nethealth_analysis_dataset.parquet
        results/by_study/s2/tables/descriptive_stats.csv
        results/by_study/s2/figures/correlation_heatmap.png
"""
...
def main():
    ...
    if len(corr_data) >= 20:
        ...
        plt.close(fig)
        print(f"    Saved: results/by_study/s2/figures/correlation_heatmap.png")
