...
Input:  results/by_study/s1/tables/*.csv, results/by_study/s1/figures/*.png
        data/processed/analysis_dataset.parquet
Output: results/by_study/s1/figures/figure_*.png (publication-ready)
        results/by_study/s1/tables/table_*.csv
...
def main():
    ...
    print("=" * 60)
    print(f"\n  Figures: results/by_study/s1/figures/figure1-7*.png")
    print(f"  Tables:  results/by_study/s1/tables/*.csv")
