...
Input:  results/by_study/s3/tables/*.csv
        results/core/three_study_*.csv
        data/processed/globem/globem_analysis_dataset.parquet
Output: results/by_study/s3/figures/figure_*.png
        results/by_study/s3/tables/table_*.csv
        results/by_study/s3/study3_report.txt
"""
