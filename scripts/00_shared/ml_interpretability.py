...
Output: results/by_study/s1/tables/shap_importance.csv
        results/by_study/s1/tables/cross_model_importance.csv
        results/by_study/s1/figures/shap_summary.png
        results/by_study/s1/figures/cross_model_importance.png
"""
