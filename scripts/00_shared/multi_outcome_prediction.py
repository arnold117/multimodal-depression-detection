...
Output: results/by_study/s1/tables/multi_model_comparison.csv
        results/by_study/s1/tables/multi_outcome_matrix.csv
        results/by_study/s1/tables/effect_size_summary.csv
        results/by_study/s1/figures/multi_outcome_heatmap.png
        results/by_study/s1/figures/multi_model_comparison.png
        results/by_study/s1/figures/effect_size_forest.png
"""
