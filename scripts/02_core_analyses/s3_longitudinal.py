...
OUT = Path("results/by_study/s3/tables")
FIG = Path("results/by_study/s3/figures")
...
print("\n  Saved: results/by_study/s3/tables/phq4_trajectory.csv")
print("  Saved: results/by_study/s3/tables/pre_post_change.csv")
