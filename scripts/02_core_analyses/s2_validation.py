...
Output: results/by_study/s2/tables/  (validation result tables)
        results/by_study/s2/figures/ (SHAP, heatmaps)
"""
...
sys.path.insert(0, str(project_root / 'scripts' / '00_shared'))
