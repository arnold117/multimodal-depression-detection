...
shap_tasks = [
    # Study 2
    ("S2", s2, "stai_trait_total", "results/by_study/s2/tables/shap_personality_stai.csv"),
    ("S2", s2, "bai_total", "results/by_study/s2/tables/shap_personality_bai.csv"),
    # Study 3
    ("S3", s3, "bdi2_total", "results/by_study/s3/tables/shap_personality_bdiii.csv"),
    ("S3", s3, "stai_state", "results/by_study/s3/tables/shap_personality_stai.csv"),
    ("S3", s3, "pss_10", "results/by_study/s3/tables/shap_personality_pss10.csv"),
    ("S3", s3, "cesd_total", "results/by_study/s3/tables/shap_personality_cesd.csv"),
    ("S3", s3, "ucla_loneliness", "results/by_study/s3/tables/shap_personality_ucla.csv"),
]
